  ...
  return (
    <div>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full overflow-y-auto rounded-lg border border-gray-200 bg-gray-50 p-4 px-3 py-4 dark:border-gray-700 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link
                to="/product"
                className="group flex items-center rounded-lg p-1 text-gray-900 transition hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              >
                <svg
                  width="22px"
                  height="22px"
                ...
                >
                  <path
                    ...
                    stroke="currentColor" // Thừa hưởng màu từ className
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                </svg>
                <span className="ms-3 flex-1 whitespace-nowrap">Email</span>
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3 flex-1 whitespace-nowrap">Members</span>
              </Link>
            </li>
            <li>
              <Link
      ...
      <div className="p-4 sm:ml-64">
        <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700"></div>
      </div>
    </div>
  );
}
